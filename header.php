...
<title>CheckMate - By Lawson T. Kurtz</title>
...
<body class="app" style="overflow: hidden;background: #555555 url(../checkmate/images/backgrounds/background.jpg) repeat 0 0;">
...
<!--
                        <li ><a href="../checkmate/dashboard">Dashboard</a>

                            <ul>

                                <li><a href="../checkmate/dashboard/activity.html">Activity</a></li>

                                <li><a href="../checkmate/dashboard/files.html">Files</a></li>

                                <li><a href="../checkmate/dashboard/calendar.html">Calendar</a></li>

                                <li><a href="../checkmate/dashboard/contacts.html">Contacts</a></li>
                        ...
                        <li ><a href="../checkmate/account/themes.html">Themes</a></li>
-->
						<!-- <li><a href="http://www.espn.com" target="_blank" title="Yes, Duke is winning."><span style="color:#00338D;">Duke 58</span> - UNC 23</a></li> -->
						
                        <li class="fr"><a href="#" class="arrow-down"><?php echo $teacher->first_name." ".$teacher->last_name; ?></a>

                            <ul>

                                <li><a href="editAccount.php">Manage Account</a></li>
								<li><a href="students.php">Add<?php if($teacher->admin ==1){ echo "/Edit"; } ?> Students</a></li>
                                <?php if($teacher->admin ==1){ ?>
								<li><a href="student_info.php">Edit Student Info</a></li>	
								<?php } ?>
		...
		<!-- Load TinyMCE -->
		<script type="text/javascript" src="../checkmate/lib/tiny_mce/jquery.tinymce.js"></script>
		<script type="text/javascript">
			$().ready(function() {
				$('textarea.tinymce').tinymce({
					// Location of TinyMCE script
					script_url : '../checkmate/lib/tiny_mce/tiny_mce.js',
		    ...
		    $(document).ready(function(){
		        $("input[name=showtinymce]").change(function(){
		            if($(this).val()==='1') {
		                $('#elm1').tinymce().show();
		            } else {
		                $('#elm1').tinymce().hide();
		...
		<!-- /TinyMCE -->
		                ...
		                <section class="main-section grid_8"  style="margin-top:7px;">
		                    <nav class="collapsed">
		                        <a class="chevron" href="#">&raquo;</a>
		                        <ul>
									<li <?php if ($page=='index.php'): echo 'class="current"'; endif; ?>><a href="index.php" class="navicon-house">Home</a></li>
		                            <li <?php if ($page=='lightning.php'): echo 'class="current"'; endif; ?>><a href="lightning.php" class="navicon-weather">Add Comments</a></li>
		                            <li <?php if ($page=='comments.php'): echo 'class="current"'; endif; ?>><a href="comments.php" class="navicon-chat-2">View Comments</a></li>
		                            <!-- <li <?php// if ($page=='students.php'): echo 'class="current"'; endif; ?>><a href="students.php" class="navicon-group">Students</a></li> -->
		                            <li <?php if ($page=='paychecks.php'): echo 'class="current"'; endif; ?>><a href="paychecks.php" class="navicon-dollar">View Paychecks</a></li>
		                            <!-- <li><a href="index.php" class="navicon-palette">Styles</a></li>
		                            <li><a href="index.php" class="navicon-photos">Nav Icons</a></li>
		                            <li><a href="index.php" class="navicon-grid">Grid System</a></li> -->
		                        </ul>
		                    </nav>